...
# functions >>> HumanEval_(number).py
...
example_py = extract_function_from_file('example_function.py')
example_java = extract_function_from_file('example_function.java')
...
query2 = f"Translate this Python function to Java:\n{function}" 
